...
public class UdpClient {
    public static void main(String[] args) {
        ...
        while (!valid) {
            ...
            if (!hotel.isEmpty() && hotelzimmer != 0 && hoteldauer != 0 && hotelankunft != null && !flug.isEmpty() && flugplaetze != 0 && reisedauer != 0 && abflug != null) {
                valid = true;
            } else {
                System.out.println("Bitte geben Sie alle Daten an.");
        ...
        String anfrageDaten = String.format("{\"hotel\":\"%s\", \"hotelzimmer\":%d, \"hoteldauer\":%d, \"hotelankunft\":\"%s\", \"flug\":\"%s\", \"flugplaetze\":%d, \"reisedauer\":%d, \"abflug\":\"%s\"}", hotel, hotelzimmer, hoteldauer, hotelankunft, flug, flugplaetze, reisedauer, abflug);
